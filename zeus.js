	...
	async handleApi(request, url, env, ctx) {
		...
		if (url.pathname === "/api/update-panel" && request.method === "POST") {
			...
			try {
				...
				const errorMsg = err.message + " | If it fails, update via: https://zeus-panel.ir-netlify.workers.dev/";
                        ...
                        <div class="pt-4 border-t-2 border-gray-200 dark:border-zinc-800">
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4 border-b border-gray-100 dark:border-zinc-800/30 pb-3">
	                            ...
	                            <div class="grid grid-cols-2 sm:flex items-center gap-2 w-full sm:w-auto">
	                            	...
	                            	<a href="https://github.com/IR-NETLIFY/zeus-relay" target="_blank" class="text-[11px] bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 px-2 py-2 sm:py-0.5 rounded border border-blue-200 dark:border-blue-800 hover:bg-blue-100 dark:hover:bg-blue-900/50 transition font-black shadow-sm text-center whitespace-nowrap">Build personal proxy</a>
	                            </div>
                            </div>
...
const NEWS_ITEMS = [
	...
	{
		title: "Version 2.0.0",
		body: "UI language switched to English, branding updated to Pixonal, and the News center was added next to Settings.",
		date: "2026-07-09",
		tag: "Release"
	},
	{
